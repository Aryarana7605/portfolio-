...
import profilePic from "../assets/AryaRana2.png"
const Hero = () => {
  return <div className="border-b border-neutral-900 pb-4 lg:mb-35">
    <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
        <div className="flex flex-col items-center lg:items-start">
            <h1 className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Arya Rana</h1>
        ...
        <div className="flex justify-center">
            <img className="rounded-2xl lg:h-96" src={profilePic} alt="Arya Rana" />
        </div>
        </div>
    </div>
  </div>
